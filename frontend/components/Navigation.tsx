    ...
    <nav className="w-full border-b border-[#D4CBB8]/50 bg-[#EDE8DC]/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="text-[#2C2C2C] font-medium text-sm tracking-tight">
            RFP Management
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full bg-[#D4CBB8] flex items-center justify-center">
            <span className="text-[#7A7265] text-xs font-medium">PM</span>
          </div>
        </div>
      </div>
    </nav>
