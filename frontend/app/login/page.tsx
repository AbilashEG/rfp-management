    ...
    <div className="min-h-screen bg-[#EDE8DC] flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div>
            <label className="block text-xs tracking-[0.1em] uppercase text-[#7A7265] mb-1.5">
              Email
            </label>
            <input
              type="email"
          ...
          {error && (
            <p className="text-xs text-[#A63D2F] bg-[#FDF2F0] border border-[#A63D2F]/20 rounded-lg px-3 py-2">
              {error}
            </p>
          )}
